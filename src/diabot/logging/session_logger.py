...
@dataclass
class SessionEvent:
    """Single event logged during a session."""
    
    timestamp: float           # Unix timestamp
    event_type: str            # decision, item_pickup, enemy_kill, potion_used, etc.
    action: str                # The action taken
    game_state: Dict[str, Any] # Game state at time of event
    result: Optional[str] = None  # Result of action
